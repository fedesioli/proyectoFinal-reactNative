...
class AboutFini extends React.Component {
    constructor(){
        super();
        this.state = {
         personasFavoritas: [],
        ...
        <View >
            ...
            <Animated.View style={{
              ...
              transform: [
               ...
               <Image style={{width: 80,height:80,marginBottom: 20}} source={require('../assets/Images/fini.jpg')} alt="" ></Image>
              <Text style={{marginBottom:10}}>Fini Quirno</Text>
